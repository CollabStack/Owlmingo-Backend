...
const { getDashboardData, getPaymentTrend } = require('../controllers/Api/v1/admin/dashboard.controller'); // Assuming you have a dashboard controller
...
privateRouter.get('/payment-trend', getPaymentTrend); // Assuming this is the correct route for payments
